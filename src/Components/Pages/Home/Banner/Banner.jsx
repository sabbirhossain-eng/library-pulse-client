        ...
        <div id="slide1" className="carousel-item relative w-full ">
          ...
          <div className="absolute h-full rounded-xl flex items-center left-0 top-0 bg-gradient-to-r from-[#e18246] to-[rgba(21, 21, 21, 0.00) 100%)]">
            <div className="text-white space-y-7 w-1/2 pl-12">
              ...
              <p>
                Biographies are non-fiction works that provide a detailed
                account of a person`s life, encompassing their experiences,
                achievements, challenges, and impact on society.
              </p>
              <div>
                <Link to="/biographies">
          ...
          <div className="absolute flex justify-end transform -translate-y-1/2 left-5 right-5 bottom-0">
            <a
              href="#slide6"
              className="btn btn-circle  border-[#f3701d] text-white hover:text-black bg-[#f3701d] mr-5"
            >
              ❮
            </a>
            <a
              href="#slide2"
              className="btn btn-circle  border-[#f3701d] text-white hover:text-black bg-[#f3701d]"
            >
              ❯
            </a>
          </div>
        ...
        <div id="slide2" className="carousel-item relative w-full">
          ...
          <div className="absolute h-full rounded-xl flex items-center left-0 top-0 bg-gradient-to-r from-[#e18246] to-[rgba(21, 21, 21, 0.00) 100%)]">
            <div className="text-white space-y-7 w-1/2 pl-12">
              ...
              <p>
                History is the study of the past, encompassing the events,
                people, societies, and developments that have shaped our world
                over time.
              </p>
              <div>
                <Link to="/history">
          ...
          <div className="absolute h-full rounded-xl flex items-center left-0 top-0 bg-gradient-to-r from-[#e18246] to-[rgba(21, 21, 21, 0.00) 100%)]">
            <div className="text-white space-y-7 w-1/2 pl-12">
              ...
              <p>
                ...
                primary goal of generating profit or providing goods and
